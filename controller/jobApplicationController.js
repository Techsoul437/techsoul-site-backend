...
export const createJobApplication = async (req, res) => {
  upload(req, res, async (err) => {
    ...
    if (!firstName || !lastName || !email || !mobileNumber || !jobRole) {
      return res.status(400).json({
        status: 400,
        success: false,
        message:
          "First name, Last name, Email, Mobile number, and Job role are required",
      });
    }
    ...
    try {
      ...
      const newJobApplication = new JobApplication({
        ...
        currentCTCRate: currentCTCRate || null,
        expectedCTC: expectedCTC || null,
        expectedCTCRate: expectedCTCRate || null,
        currentLocation: currentLocation || null,
        noticePeriod: noticePeriod || null,
        sourceOfReferral: sourceOfReferral || null,
        jobRole,
